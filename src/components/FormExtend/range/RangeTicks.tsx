...
export const RangeTicks: ({disabled, onChange, ticks, tickSequence, value, max, min, interval}: {
  ...
  return (
    <div className="softRangeTicks" style={ticksStyle}>
      {tickSequence.map(tickValue => {
        ...
        const tickClasses = classNames('softRangeTick', {
          'softRangeTick--selected': value === tickValue,
          'softRangeTick--isCustom': customTick,
        });
