...
import {RangeLevels, LEVEL_COLORS} from './SoftRangeLevels';
import {RangeTicks} from './SoftRangeTicks';
...
export class RangeTrack extends Component<{
  ...
  render() {
    ...
    const trackClasses = classNames('softRangeTrack', {
      'softRangeTrack--disabled': disabled
    });
