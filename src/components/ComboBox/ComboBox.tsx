...
import {SoftComboBoxInput} from './combo_box_input';
import {SoftComboBoxOptionsList} from './combo_box_options_list';
...
export class ComboBox extends Component<{
  ...
  render() {
    ...
    const classes = classNames('softComboBox', className, {
      'softComboBox-isOpen': isListOpen,
      'softComboBox-isInvalid': markAsInvalid,
      'softComboBox-isDisabled': isDisabled,
      'softComboBox--fullWidth': fullWidth,
      'softComboBox--compressed': compressed,
    });
