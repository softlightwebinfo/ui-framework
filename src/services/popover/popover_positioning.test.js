...
describe('popover_positioning', function () {
    describe('getElementBoundingBox', function () {
        ...
        beforeEach(function () { return (HTMLElement.prototype.getBoundingClientRect = function () { return clientRect; }); });
        afterEach(function () {
    ...
    describe('getAvailableSpace', function () {
        // 50h x 30w
        var anchorBoundingBox = { top: 100, right: 60, bottom: 150, left: 30 };
        // 80h x 65w
        var containerBoundingBox = { top: 10, right: 90, bottom: 190, left: 25 };
        ...
        it('subtracts the offset from the specified offsetSide', function () {
            POSITIONS.forEach(function (side) {
                var _a;
                expect(getAvailableSpace(anchorBoundingBox, containerBoundingBox, 0, 5, side)).toEqual(__assign({}, expectedAvailableSpace, (_a = {}, _a[side] = expectedAvailableSpace[side] - 5, _a)));
            });
        });
        it('subtracts the buffer and the offset from the specified offsetSide', function () {
            POSITIONS.forEach(function (side) {
                var _a;
                expect(getAvailableSpace(anchorBoundingBox, containerBoundingBox, 3, 1, side)).toEqual((_a = {
                        // apply buffer space
                    ...
                    _a[side] = expectedAvailableSpace[side] - 3 - 1,
                    _a));
            });
        });
    });
    describe('getVisibleFit', function () {
        it('calculates full visibility when content is fully enclosed by container', function () {
            var content = { top: 25, right: 50, bottom: 50, left: 25 };
            var container = { top: 0, right: 500, bottom: 500, left: 0 };
            expect(getVisibleFit(content, container)).toBe(1);
        });
        it('calculates full visibility when container is the same size', function () {
            var content = { top: 25, right: 50, bottom: 50, left: 25 };
            var container = { top: 25, right: 50, bottom: 50, left: 25 };
            expect(getVisibleFit(content, container)).toBe(1);
        });
        it('calculates partial visibility when content overflows out of container', function () {
            var content = { top: -5, right: 5, bottom: 5, left: -5 };
            var container = { top: 0, right: 10, bottom: 10, left: 0 };
        ...
        it('calculates zero visibility when content is not in the container', function () {
            var content = { top: -10, right: -5, bottom: -5, left: -10 };
            var container = { top: 0, right: 10, bottom: 10, left: 0 };
    ...
    describe('findPopoverPosition', function () {
        ...
        describe('placement in desired position', function () {
            it('finds space in the requested position', function () {
                ...
                anchor.getBoundingClientRect = function () { return makeBB(100, 150, 120, 50); };
                var popover = document.createElement('div');
                popover.getBoundingClientRect = function () { return makeBB(0, 30, 50, 0); };
                var container = document.createElement('div');
                container.getBoundingClientRect = function () { return makeBB(0, 1024, 768, 0); };
        ...
        describe('placement falls back to position on same axis', function () {
            it('finds space in the requested position', function () {
                ...
                var container = document.createElement('div');
                container.getBoundingClientRect = function () { return makeBB(50, 300, 768, 30); };
                expect(findPopoverPosition({
                    position: 'left',
                    anchor: anchor,
                    popover: popover,
        ...
        describe('placement falls back to first complementary position', function () {
            it('finds space in the requested position', function () {
                ...
                var container = document.createElement('div');
                container.getBoundingClientRect = function () { return makeBB(0, 160, 768, 40); };
                expect(findPopoverPosition({
                    position: 'right',
                    anchor: anchor,
                    popover: popover,
        ...
        describe('placement falls back to second complementary position', function () {
            it('finds space in the requested position', function () {
                ...
                var container = document.createElement('div');
                container.getBoundingClientRect = function () { return makeBB(100, 160, 768, 40); };
                expect(findPopoverPosition({
                    position: 'right',
                    anchor: anchor,
                    popover: popover,
        ...
        describe('disable positioning on the cross-axis', function () {
            it('forces the popover to stay on the primary axis', function () {
                var anchor = document.createElement('div');
                anchor.getBoundingClientRect = function () { return makeBB(450, 150, 550, 50); };
                var popover = document.createElement('div');
                popover.getBoundingClientRect = function () { return makeBB(0, 30, 100, 0); };
                var container = document.createElement('div');
                container.getBoundingClientRect = function () { return makeBB(400, 1024, 600, 0); };
                expect(findPopoverPosition({
                    position: 'top',
                    anchor: anchor,
                    popover: popover,
