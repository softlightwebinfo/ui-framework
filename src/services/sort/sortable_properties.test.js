...
describe('SortProperties', function () {
    var name = {
        name: 'name',
        getValue: function (bird) { return bird.name; },
        isAscending: true,
    };
    var size = {
        name: 'size',
        getValue: function (bird) { return bird.size; },
        isAscending: false,
    };
    var color = {
        name: 'color',
        getValue: function (bird) { return bird.color; },
        isAscending: true,
    };
    var birds = [
        {
    ...
    describe('initialSortProperty', function () {
        ...
        test('throws an error with an invalid property name', function () {
            expect(function () { return new SortableProperties([name, size, color], 'does not exist'); }).toThrow();
        });
        test('throws an error property name is not defined', function () {
            expect(function () { return new SortableProperties([name, size, color]); }).toThrow();
        });
    });
